        ...
        <div className="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div className="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg text-right overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full transition-colors">
                    <div className="bg-emerald-600 dark:bg-emerald-900/50 px-4 py-3 sm:px-6 flex items-center border-b border-emerald-500/20 transition-colors">
                        <h3 className="text-lg leading-6 font-medium text-white dark:text-emerald-400 flex items-center gap-2" id="modal-title">
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="bg-gray-50 dark:bg-slate-700/50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2 transition-colors">
                            <button
                                type="submit"
                                className="w-full inline-flex justify-center items-center gap-2 rounded-md border border-transparent shadow-sm px-4 py-2 bg-emerald-600 text-base font-medium text-white hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 sm:w-auto sm:text-sm transition-colors disabled:opacity-50"
                                disabled={submitting}
                            >
                                {submitting ? (
                                    <>
