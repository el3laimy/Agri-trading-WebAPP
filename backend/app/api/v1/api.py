...
from app.api.v1.endpoints import contacts, crops, purchases, sales, financial_accounts, reports, expenses, journal, inventory, payments, seasons, sale_returns, purchase_returns, daily_prices, treasury, auth, backup, notifications, contracts, capital, system, assets
